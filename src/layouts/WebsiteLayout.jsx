...
export default function CustomerLayout({ children }) {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      {/* Footer */}
      <footer className="bg-gradient-to-br from-slate-50 to-slate-100 border-t mt-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
            ...
            <div className="space-y-4">
              ...
              <div className="flex space-x-4">
                <Link
                  to="#"
                  className="text-gray-600 hover:text-pink-500 transition-colors p-2 hover:bg-white rounded-md"
                >
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <Link to="/cakes" className="text-gray-600 hover:text-pink-500 transition-colors text-sm">
                    Browse Cakes
                  </Link>
                </li>
                <li>
                  <Link to="/about" className="text-gray-600 hover:text-pink-500 transition-colors text-sm">
                    About Us
                  </Link>
                </li>
                <li>
                  <Link to="/contact" className="text-gray-600 hover:text-pink-500 transition-colors text-sm">
                    Contact
                  </Link>
                </li>
              </ul>
            ...
            {/* Cake Categories */}
            <div>
              <h3 className="font-semibold text-lg mb-4 text-gray-900">Cake Categories</h3>
              <ul className="space-y-3">
                <li>
                  <Link to="/cakes?category=birthday" className="text-gray-600 hover:text-pink-500 transition-colors text-sm">
                    Birthday Cakes
                  </Link>
                </li>
                <li>
                  <Link to="/cakes?category=wedding" className="text-gray-600 hover:text-pink-500 transition-colors text-sm">
                    Wedding Cakes
                  </Link>
                </li>
                <li>
                  <Link to="/cakes?category=anniversary" className="text-gray-600 hover:text-pink-500 transition-colors text-sm">
                    Anniversary Cakes
                  </Link>
                </li>
                <li>
                  <Link to="/cakes?category=celebration" className="text-gray-600 hover:text-pink-500 transition-colors text-sm">
                    Celebration Cakes
                  </Link>
                </li>
                <li>
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-start space-x-3">
                  <MapPin className="w-4 h-4 text-gray-600 flex-shrink-0 mt-0.5" />
                    <span className="text-gray-600 text-sm">123 Glacé Street, Bakery City, BC 12345</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="border-t pt-8 mt-8">
            <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
              ...
              <div className="flex flex-wrap justify-center md:justify-end gap-6">
                <Link to="/privacy" className="text-sm text-gray-600 hover:text-pink-500 transition-colors">
                  Privacy Policy
                </Link>
                <Link to="/terms" className="text-sm text-gray-600 hover:text-pink-500 transition-colors">
                  Terms of Service
                </Link>
                <Link to="/cookies" className="text-sm text-gray-600 hover:text-pink-500 transition-colors">
                  Cookie Policy
                </Link>
              </div>
            </div>
